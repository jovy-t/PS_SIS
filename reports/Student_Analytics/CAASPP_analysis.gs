...
const OLD_DATA_URL_FRAGMENT = "16yATK5aM8-CdGgYRHLXcR2bG5rXzp5_xV__erxh-m8Y"; // Unique part of the 22-23 URL
...
function compileAllData() {
  ...
  const sourceSheetUrls = [
    "https://docs.google.com/spreadsheets/d/1XWCueWrBI5xNNOSgmnm9d3LS1bs38oK8tiFbnhRhtQM/edit#gid=0", // 24-25
    "https://docs.google.com/spreadsheets/d/1S1b9IomBfftRWIa10gll57Qbi_LngP18k9bxsEjuBbs/edit#gid=0", // 23-24
    "https://docs.google.com/spreadsheets/d/16yATK5aM8-CdGgYRHLXcR2bG5rXzp5_xV__erxh-m8Y/edit#gid=0"  // 22-23 (Old structure)
  ];
